    ...
    return (
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        <div className="surface-card p-8 text-center">
          <p className="text-sm font-bold text-brand-700">Không có quyền truy cập</p>
          <h1 className="mt-3 text-2xl font-black text-slate-950">Khu vực này chỉ dành cho quản trị viên.</h1>
          <p className="mt-3 text-sm leading-7 text-slate-500">
            Vui lòng quay lại trang chủ hoặc đăng nhập bằng tài khoản quản trị.
          </p>
        </div>
      </main>
    );
