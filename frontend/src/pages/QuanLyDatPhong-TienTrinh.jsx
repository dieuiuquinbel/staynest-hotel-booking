...
function layBuocHienTai(booking) {
  if (booking.bookingStatus === TRANG_THAI_DAT_PHONG.CANCELLED || booking.bookingStatus === TRANG_THAI_DAT_PHONG.NO_SHOW) return 0;
...
function QuanLyDatPhongTienTrinh({ booking }) {
...
export default QuanLyDatPhongTienTrinh;
